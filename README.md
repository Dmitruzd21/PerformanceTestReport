...
**Примечание:** тестирование выполнялось на ПК (процессор - AMD Ryzen 5 3500U with Radeon Vega Mobile Gfx 2.10 GHz), оперативная память - 8,00 ГБ (доступно: 5,95 ГБ). OS Windows 10.
